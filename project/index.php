...
?>
<div class="content pb-0" style="background-color:lightseagreen"";>
            <div class="orders">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
						   ...
						   <h4 class="box_title_link"><a href="add_department.php">
                        Add Department</a> </h4>
                        </div>
                        <div class="card-body--">
                              ...
                              <table class="table ">
                                 ...
                                 <tbody>
									...
									<tr>
									   ...
									   <td><a href="add_department.php?id=<?php echo $row['id']?>">
                              Edit</a> <a href="index.php?id=<?php echo $row['id']?>
